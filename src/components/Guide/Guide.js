                ...
                <ul className='guide'>
                    <li>
                        <div className='guide-list-wrap'>
                            ...
                            <p className='guide-description'> Dive straight into building software projects by selecting one from below. There are guided projects for people with all level of experience.</p>
                        </div>
                    </li>
                    <li>
                        <div className='guide-list-wrap'>
